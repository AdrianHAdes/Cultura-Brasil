...
const perguntas = [
    {
        enunciado: "Carnaval é uma festa culturalmente significativa no Brasil?",
        alternativas: ["Sim", "Não"],
    },
    {
        enunciado: "A Capoeira é uma forma de expressão cultural afro-brasileira?",
        alternativas: ["Sim", "Não"],
    },
    {
        enunciado: " samba é um gênero musical tradicionalmente brasileiro?",
        alternativas: ["Sim", "Não"],
    },
];
